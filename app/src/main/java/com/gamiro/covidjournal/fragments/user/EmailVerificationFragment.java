...
public class EmailVerificationFragment extends Fragment {
    ...
    private static final String TAG = "EmailVerifFragment";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editEmail = getView().findViewById(R.id.edit_send_email);
        editPassword = getView().findViewById(R.id.edit_send_password);
        btnSendEmail = getView().findViewById(R.id.btn_send_email);
